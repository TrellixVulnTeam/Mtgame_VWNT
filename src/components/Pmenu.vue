    ...
    methods: {
      ...
      change() {
        if (this.UnitsList.length != 0) {
          this.spanp = "Look closely and find the letters.";
          setTimeout(() => {
            this.changei1 = true;
            this.popp = !this.popp;
      ...
      change7() {
        if (this.key != true && this.UnitsList.length != 0) {
          this.spanp = "Listen to the sentence and look at the picture. \n" +
      ...
      change10() {
        if (this.key != true && this.UnitsList.length != 0) {
          this.spanp = "Listen to the word and write the missing letter.";
          setTimeout(() => {
            this.changei10 = true;
            this.popp = !this.popp;
                ...
                this.$axios.post(this.url3, qs.stringify({
                  ...
                  for(var i=0;i<this.phonicsDetailList.length;i++){
                    if(this.phonicsDetailList[i].name==this.$route.query.unit){
                      ...
                      this.$axios.post(this.url+"PhonicsMenu", qs.stringify({
                        studentId: localStorage.getItem('studentId'),
