<template>
  <div class="advanced7">
    ...
    <img src="../../assets/image/advancebg7.png"
          ...
          <div v-show="!onef" style="width: 100%; height: 90%;text-align: center;display:block;position: fixed;">
            ...
            <div class="rightbox">
              ...
              <div class="buttons" id="imgBox">
                <button v-for="(li,index) in list1" :key="index" class="item listitems imgsty"
                        v-bind:class="{changeopcily:li.fail,changetranform:li.successful}">
                  <!--<span class="listgroup" v-bind:class="{ bluefont:li.bluesuccess,pinkfont:li.redsuccess}">{{li.name}}</span>-->
                  <img class="listgroup" src="../../assets/image/arepeatball.png" v-if="index==0">
              ...
              <canvas id="canvas" style="position: absolute;left:0;top:0%;z-index: 99;width: 100%;height: 100%;"
                      @click="xy($event)" @mousedown="canvasDown($event)" @mouseup="canvasUp($event)"
    ...
    <div class='popContainer' v-show="popp">
      ...
      <div class="withcolor oringe">
        ...
        <img class="animapng7" style="margin-top: 10%;"
             src="http://103.218.241.33/mtgameweb/assets/img/advanced7.gif">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      help() {
        if (this.onef == false) {
          this.spanp = "Listen and circle the wrong picture.";
          this.popp = !this.popp;
