  ...
  <div class="advanced9">
            ...
            <div class="leftbox">
              ...
              <div class="listbar">
                ...
                <div v-bind:class="{'answer':answer}" class="leftimg" @click="change">
                  ...
                  <img src='../../assets/image/aroll.png'  style="width: 100%; float: left;">
    ...
    <div class='popContainer' v-show="popp">
      ...
      <div class="withcolor oringe">
        ...
        <img class="animapng7" src="http://monkeytown.monkeytree.com.hk/image/advanced9.gif">
