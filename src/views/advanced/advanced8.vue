<template>
  <div class="advanced8">
    ...
    <img src="../../assets/image/advancebg8.png" style="width: 100%; height: 100%;top:0;display:block;position: absolute;">
            ...
            <div class="dndList" v-if="!reload">
              <div class="allansw">
                ...
                <div class="bordercolor" id="answer-box">
                  <draggable id="box2" :list="items2" draggable=".item" style="opacity: 0;" class="yes dragArea list-group"
                             group="people" @change="log">
                    <div class="list-group-item" style="opacity: 0;display: none;" v-for="element in items2" :key="element.id">
                      <!-- {{ element.name }} -->
                    </div>
                ...
                <button class="fast" @click="sound1()"  v-bind:class="{answer: issuccess1,listimg:fangda1}">
                  <img style="max-height: 100%;max-width: 100%;    height: 100%;" src="../../assets/image/cat1.png">
              ...
              <div class="allansw">
                ...
                <div class="bordercolor" id="answer-box1">
                  <draggable id="box4" :list="items4" draggable=".item" style="opacity: 0;"  class="no dragArea list-group"
                             group="people" @change="log">
                    <div class="list-group-item" style="opacity: 0;display: none;" v-for="element in items4" :key="element.id">
                      <!--  {{ element.name }} -->
                    </div>
                ...
                <button class="fast2"  @click="sound2()" v-bind:class="{answer: issuccess2,listimg:fangda2}">
                  <img style="max-height: 100%;max-width: 100%;    height: 100%;" src="../../assets/image/cat2.png">
              ...
              <div class="allansw">
                ...
                <div class="bordercolor" id="answer-box2">
                  <draggable id="box5" :list="items5" draggable=".item" style="opacity: 0;"  class="no dragArea list-group"
                             group="people" @change="log">
                    <div class="list-group-item" style="opacity: 0;display: none;" v-for="element in items5" :key="element.id">
                ...
                <button class="fast3"  @click="sound3()" v-bind:class="{answer: issuccess3,listimg:fangda3}">
                  <img style="max-height: 100%;max-width: 100%;    height: 100%;" src="../../assets/image/cat3.png">
              ...
              <div class="alldrag">
                <draggable id="first"
                  ...
                  <div v-for="(element,index) in items1" :key="element.id" class="item" style="display: inline-block;position: relative;">
                    <img src="../../assets/image/fish.png" class="classimg" @click="speak(index)" v-bind:class="{ marginboth:marginboth,touming:element.imgop}" >
    ...
    <div class='popContainer' v-show="popp">
      ...
      <div class="withcolor oringe">
        ...
        <img class="animapng7" src="http://103.218.241.33/mtgameweb/assets/img/advanced8.gif">
...
//
      ...
      help(){
        if (this.onef == false) {
          this.spanp = "Listen and match the words to the sound.";
          this.popp = !this.popp;
