<template>
  <div class="advanced10">
    <span id="gameplay">
      <audio autoplay="autoplay" loop="loop" ref="MusicPlay" v-if="show" id="partmusic">
        <source src="../../assets/video/gamemusic.mp3"></audio>
    </span>
    <img src="../../assets/image/advancebg9.png" style="width: 100%; z-index: -1; height: 100%;display:block;position: absolute;">
    ...
    <div class='popContainer' v-show="popp">
      ...
      <div class="withcolor oringe">
        ...
        <img class="animapng7" src="http://103.218.241.33/mtgameweb/assets/img/advanced10.gif">
  ...
  export default {
    ...
    watch: {
      'onef': function(newVal) {
        if (this.onef == true) {
          this.truelist=[];
          setTimeout(() => {
            this.wordname = this.listBoss[this.countpage - 1][0].word;
    ...
    data() {
      return {
        ...
        warn: "Listen and spell the word.",
    ...
    created() { //生命周期里接收参数
      ...
      this.$axios.post(this.url, qs.stringify({
        ...
        for (let i in res.data.maps) {
          ...
          var data1=this.listBoss[i][0].word.split('');
...
<style scoped lang="less">
  ...
  /*.widthline {*/
  /*width: 5%;*/
  /*border-bottom: 4px solid #91911c;*/
  /*height: 100%;*/
  /*display: inline-block;*/
  /*}*/
