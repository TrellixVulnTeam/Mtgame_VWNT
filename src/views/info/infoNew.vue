        ...
        <div class="rightmenu">
          ...
          <div class="bottommemu" v-bind:class="{backgrgreen:backgrgreen,backgrorang:backgrorang}">
            ...
            <div class="phonicsLevel" v-if="!chatorphonics&&opciay1 || !chatorphonics&&page2">
              ...
              <img src="../../assets/image/cardleft.png" class="cardLeft" @click="$tips(true);cardLeft()"
                   v-if="opciay2 && categoriesName !== 'Performance Report'">
              <img src="../../assets/image/cardright.png" class="cardRight" @click="$tips(true);cardRight()"
                   v-if="opciay2 && categoriesName !== 'Performance Report'">
            </div>
            ...
            <div class="chosedisplay" v-if="!chatorphonics">
              <div v-if="opciay1" style="width: 95%;display: inline-block">
                <div class="choicephonics" v-for="(li,index) in phonicsList" :key='index'>
                  <img src="../../assets/image/beginner.png" @click="$tips(true);pnext2(li)" style="width: 90%;"
                       v-if="index===0">
                  <img src="../../assets/image/intermediate.png" @click="$tips(true);pnext21(li)" style="width: 90%;"
                       v-if="index===1">
                  <img src="../../assets/image/advance.png" style="width: 90%;" @click="$tips(true);pnext22(li)"
                       v-if="index===2">
                  <!--<div class="progress" >-->
              ...
              <div v-if="opciay2" style="width: 100%;height: 100%;">
                <div class="categories"
                  ...
                  <div v-if="categoryNum===5">
                    <div class="Strengths" v-for="(li,index) in strengthsTemp" :key='index'>
                      <div class="strengthsDiv">
                        <div class="strengthsL" v-if="Object.values(li)[0].classification==='Blend Recognition'"
                             style="background: #1ac6d9">
                          <div class="strengthsText">{{ Object.values(li)[0].classification }}</div>
                        </div>
                        <div class="strengthsL" v-if="Object.values(li)[0].classification==='Sound Recognition'"
                             style="background: #3793a8">
                          <div class="strengthsText">{{ Object.values(li)[0].classification }}</div>
                        </div>
                        <div class="strengthsL" v-if="Object.values(li)[0].classification==='Spelling'"
                             style="background: #ffa217">
                          <div class="strengthsText">{{ Object.values(li)[0].classification }}</div>
                        </div>
                        <div class="strengthsL" v-if="Object.values(li)[0].classification==='Letter Recognition'"
                             style="background: #f55b5b">
                          <div class="strengthsText">{{ Object.values(li)[0].classification }}</div>
                        </div>
                        <div class="strengthsL" v-if="Object.values(li)[0].classification==='Listening'"
                             style="background: #48cfdb">
                          <div class="strengthsText">{{ Object.values(li)[0].classification }}</div>
                        </div>
                        <div class="strengthsL" v-if="Object.values(li)[0].classification==='Reading'"
                             style="background: #8460cc">
                          <div class="strengthsText">{{ Object.values(li)[0].classification }}</div>
                        </div>
                        <div class="strengthsL" v-if="Object.values(li)[0].classification==='Vocabulary'"
                             style="background: #00c455">
                          <div class="strengthsText">{{ Object.values(li)[0].classification }}</div>
                        </div>
                        <div class="strengthsL" v-if="Object.values(li)[0].classification==='Writing'"
                             style="background: #de81ca">
                          <div class="strengthsText">{{ Object.values(li)[0].classification }}</div>
                        </div>
                        ...
                        <div class="strengthsLiAll">
                          <div class="strengthsLi" v-for="(li2,index2) in li" :key='index2'>
                            <div :class="level==='Advanced'?'strengthsAbbreviationAdvanced':'strengthsAbbreviation'"
                                 v-if="index2!==0">{{ li2.letter }}
                            </div>
                            <div :class="level==='Advanced'?'strengthsAbbreviationAdvanced':'strengthsAbbreviation'"
                                 v-if="Object.values(li)[0].classification==='Blend Recognition'&&index2===0"
                                 style="color: #1ac6d9">{{ li2.letter }}
                            </div>
                            <div :class="level==='Advanced'?'strengthsAbbreviationAdvanced':'strengthsAbbreviation'"
                                 v-if="Object.values(li)[0].classification==='Sound Recognition'&&index2===0"
                                 style="color: #3793a8">{{ li2.letter }}
                            </div>
                            <div :class="level==='Advanced'?'strengthsAbbreviationAdvanced':'strengthsAbbreviation'"
                                 v-if="Object.values(li)[0].classification==='Spelling'&&index2===0"
                                 style="color: #ffa217">{{ li2.letter }}
                            </div>
                            <div :class="level==='Advanced'?'strengthsAbbreviationAdvanced':'strengthsAbbreviation'"
                                 v-if="Object.values(li)[0].classification==='Letter Recognition'&&index2===0"
                                 style="color: #f55b5b">{{ li2.letter }}
                            </div>
                            <div :class="level==='Advanced'?'strengthsAbbreviationAdvanced':'strengthsAbbreviation'"
                                 v-if="Object.values(li)[0].classification==='Listening'&&index2===0"
                                 style="color: #48cfdb">{{ li2.letter }}
                            </div>
                            <div :class="level==='Advanced'?'strengthsAbbreviationAdvanced':'strengthsAbbreviation'"
                                 v-if="Object.values(li)[0].classification==='Reading'&&index2===0"
                                 style="color: #8460cc">{{ li2.letter }}
                            </div>
                            <div :class="level==='Advanced'?'strengthsAbbreviationAdvanced':'strengthsAbbreviation'"
                                 v-if="Object.values(li)[0].classification==='Vocabulary'&&index2===0"
                                 style="color: #00c455">{{ li2.letter }}
                            </div>
                            <div :class="level==='Advanced'?'strengthsAbbreviationAdvanced':'strengthsAbbreviation'"
                                 v-if="Object.values(li)[0].classification==='Writing'&&index2===0"
                                 style="color: #de81ca">{{ li2.letter }}
                            </div>
                            <div class="strengthsLogo2Div">
                              <img class="strengthsLogo2" v-if="index2!==0" src="../../assets/image/allColor.png"/>
                              <img class="strengthsLogo2"
                                   v-if="Object.values(li)[0].classification==='Blend Recognition' && Object.values(li)[0].persent!==undefined && index2===0"
                                   src="../../assets/image/BlendRecognitionColor.png"/>
                              <img class="strengthsLogo2"
                                   v-if="Object.values(li)[0].classification==='Sound Recognition' && Object.values(li)[0].persent!==undefined && index2===0"
                                   src="../../assets/image/SoundRecognitionColor.png"/>
                              <img class="strengthsLogo2"
                                   v-if="Object.values(li)[0].classification==='Spelling' && Object.values(li)[0].persent!==undefined && index2===0"
                                   src="../../assets/image/spellingColor.png"/>
                              <img class="strengthsLogo2"
                                   v-if="Object.values(li)[0].classification==='Letter Recognition' && Object.values(li)[0].persent!==undefined && index2===0"
                                   src="../../assets/image/LetterRecognitionColor.png"/>
                              <img class="strengthsLogo2"
                                   v-if="Object.values(li)[0].classification==='Listening' && Object.values(li)[0].persent!==undefined && index2===0"
                                   src="../../assets/image/listeningColor.png"/>
                              <img class="strengthsLogo2"
                                   v-if="Object.values(li)[0].classification==='Reading' && Object.values(li)[0].persent!==undefined && index2===0"
                                   src="../../assets/image/readingColor.png"/>
                              <img class="strengthsLogo2"
                                   v-if="Object.values(li)[0].classification==='Vocabulary' && Object.values(li)[0].persent!==undefined && index2===0"
                                   src="../../assets/image/vocabularyColor.png"/>
                              <img class="strengthsLogo2"
                                   v-if="Object.values(li)[0].classification==='Writing' && Object.values(li)[0].persent!==undefined && index2===0"
                                   src="../../assets/image/writingColor.png"/>
                            </div>
                            <div class="strengthsPresent" v-if="Object.values(li)[0].persent!==undefined">
                              {{ li2.persent }}%
                            </div>
                          </div>
                        </div>
                      ...
                      <table style="color: #007BB8; margin-top: 0;">
                        <tr v-for="(li,index) in history" :key="index">
                          ...
                          <td class="historyLi" style="width: 10%;">
                            <img src="../../assets/image/star_frame.png"
                                 v-if="li.star===1 || li.star===2 || li.star===3"
                                 class="littlestar">
                            ...
                            <img src="../../assets/image/star_frame.png" v-if="li.star===2 || li.star===3"
                                 class="littlestar">
                            <img src="../../assets/image/Little_Star_frame.png" v-if="li.star===0 || li.star===1"
                                 class="littlestar">

                            <img src="../../assets/image/star_frame.png" v-if="li.star===3"
                                 class="littlestar">
                            <img src="../../assets/image/Little_Star_frame.png"
                                 v-if="li.star===0 || li.star===1 || li.star===2" class="littlestar">
                          </td>
                  ...
                  <div v-if="categoryNum === 6 &&comingSoon ===true"
                       style="height: 100%;font-size: 48px;color: #7d4e28;display: flex;align-items: center;justify-content: center;">
                    <p>coming soon!</p>
                  </div>
                </div>
                <!--Scores for key areas-->
                <div class="areasDiv" v-if="categoryNum === 4">
                  <div class="areasButton">
                    <div class="areasButton1" :style="symbolNub ==='1' ? symbolColor:symbolDefaultColor"
                         @click="$tips(true);areas('Vocabulary')">Vocabulary
                    </div>
                    <div class="areasButton1" :style="symbolNub ==='2' ? symbolColor:symbolDefaultColor"
                         @click="$tips(true);areas('Spelling')">Spelling
                    </div>
                    <div class="areasButton1" :style="symbolNub ==='3' ? symbolColor:symbolDefaultColor"
                         @click="$tips(true);areas('Writing')" v-if="level === 'Beginner'">Writing
                    </div>
                    <div class="areasButton1" :style="symbolNub ==='4' ? symbolColor:symbolDefaultColor"
                         @click="$tips(true);areas('Letter')" v-if="level === 'Beginner'">Letter Recognition
                    </div>
                    <div class="areasButton1" :style="symbolNub ==='5' ? symbolColor:symbolDefaultColor"
                         @click="$tips(true);areas('Sound')" v-if="level === 'Beginner'">Sound Recognition
                    </div>
                    <div class="areasButton1" :style="symbolNub ==='6' ? symbolColor:symbolDefaultColor"
                         @click="$tips(true);areas('Reading')" v-if="level !== 'Beginner'">Reading
                    </div>
                    <div class="areasButton1" :style="symbolNub ==='7' ? symbolColor:symbolDefaultColor"
                         @click="$tips(true);areas('Blend')" v-if="level !== 'Beginner'">Blend Recognition
                    </div>
                  </div>
                  <div class="areas">
                ...
                <div class="intervals" v-if="categoryNum === 2">
                  ...
                  <div class="intervalsPosition">
                    ...
                    <p class="intervalsPass">You are better than <span style="color: #6CB0A4">{{ pass }}%</span> of
                      players.</p>
                  </div>
                </div>
                ...
                <div class="intervals" v-if="categoryNum === 3">
                  <div class="intervalsPass7">
                    <div
                      :class="{intervalsPassAmazing:evaluate ==='AMAZING',intervalsPassKeepTrying:evaluate ==='KEEP TRYING',intervalsPassGreat:evaluate ==='GREAT',intervalsPassNice:evaluate ==='NICE'}">
                      {{ evaluate }}
                    </div>
                  ...
                  <div class="intervalsPass30">
                    <div
                      :class="{intervalsPassAmazing:evaluate2 ==='AMAZING',intervalsPassKeepTrying:evaluate2 ==='KEEP TRYING',intervalsPassGreat:evaluate2 ==='GREAT',intervalsPassNice:evaluate2 ==='NICE'}">
                      {{ evaluate2 }}
                    </div>
