...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // },
      gochoice(li){
        if(li.name==='ENGLISH ADVENTURE'){
          this.booktitleColor='#56CDCC';
          this.$router.push({
            path: '/ebookchioce',
            query: {
              sortId:this.sortId,
              booklevelid:li.id,
              booklevel:li.name,
              booklevel2:this.booklevel,
              booktitleColor:this.booktitleColor
            }
          })
        }else if(li.name==='CONCEPT LEARNING'){
          this.booktitleColor='#FF9100';
          this.$router.push({
            path: '/ebookchioce',
            query: {
              sortId:this.sortId,
        ...
        }else if(li.name==='WORD FAMILY READERS'){
          this.booktitleColor='#FF5834';
          this.$router.push({
            path: '/ebookchioce',
            query: {
              sortId:this.sortId,
        ...
        }else if(li.name==='EMGLISH ADVENTURE'){
          this.booktitleColor='#FF5E80';
          this.$router.push({
            path: '/ebookchioce',
            query: {
              sortId:this.sortId,
        ...
        }else if(li.name==='SHORT STORY READERS'){
          this.booktitleColor='#BB58DB';
          this.$router.push({
            path: '/ebookchioce',
            query: {
              sortId:this.sortId,
        ...
        }else if(li.name==='BEGINNER'){
          this.booktitleColor='#FFB500';
          this.$router.push({
            path: '/ebookchioce',
            query: {
              sortId:this.sortId,
        ...
        }else if(li.name==='INTERMEDIATE'){
          this.booktitleColor='#F77E11';
          this.$router.push({
            path: '/ebookchioce',
            query: {
              sortId:this.sortId,
        ...
        }else if(li.name==='ADVANCED'){
          this.booktitleColor='#FF545B';
          this.$router.push({
            path: '/ebookchioce',
            query: {
              sortId:this.sortId,
    ...
    created() { //生命周期里接收参数
      ...
      // if(this.$route.query.phonicsbook==true){
      //   this.gophonics();
      // }
      ...
      this.$axios.post(this.url,qs.stringify({
        sortId:this.sortId
          ...
          this.listBook=res.data.listBook;
          for(var i=0;i<this.listBook.length;i++){
            this.listBook[i].bg=this.pic+this.listBook[i].bg;
          }
      }, res => {
