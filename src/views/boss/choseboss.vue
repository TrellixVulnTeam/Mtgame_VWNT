<template>
	<div class="choseboss">
		<transition name="fades">
            ...
            <div class="stylebar" style="background-color: #EA5D13;" v-if="bgimg[0].active"><p class="stylefont">{{this.spring}}</p></div>
						<div class="stylebar" style="background-color: #289D4F;" v-if="bgimg[1].active"><p class="stylefont">{{this.spring}}</p></div>
						<div class="stylebar" style="background-color: #AD59AE;" v-if="bgimg[2].active"><p class="stylefont">{{this.spring}}</p></div>
						<div class="stylebar" style="background-color: #0090C8;" v-if="bgimg[3].active"><p class="stylefont">{{this.spring}}</p></div>
						<div class="stylebar" style="background-color: #B8122E;" v-if="bgimg[4].active"><p class="stylefont">{{this.spring}}</p></div>
						<div class="stylebar" style="background-color: #00539E;" v-if="bgimg[5].active"><p class="stylefont">{{this.spring}}</p></div>
						<div class="stylebar" style="background-color: #FF80A1;" v-if="bgimg[6].active"><p class="stylefont">{{this.spring}}</p></div>
						<div class="stylebar" style="background-color: #A45927;" v-if="bgimg[7].active"><p class="stylefont">{{this.spring}}</p></div>
						<div class="stylebar" style="background-color: #42B8E2;" v-if="bgimg[8].active"><p class="stylefont">{{this.spring}}</p></div>
						<div class="stylebar" style="background-color: #117500;" v-if="bgimg[9].active"><p class="stylefont">{{this.spring}}</p></div>
						<div class="stylebar" style="background-color: #D42C2C;" v-if="bgimg[10].active"><p class="stylefont">{{this.spring}}</p></div>
						<div class="stylebar" style="background-color: #009145;" v-if="bgimg[11].active"><p class="stylefont">{{this.spring}}</p></div>
						<div class="stylebar" style="background-color: #FF7F00;" v-if="bgimg[12].active"><p class="stylefont">{{this.spring}}</p></div>
						<div class="stylebar" style="background-color: #3ECCB1;" v-if="bgimg[13].active"><p class="stylefont">{{this.spring}}</p></div>
						<div class="stylebar" style="background-color: #009BE8;" v-if="bgimg[14].active"><p class="stylefont">{{this.spring}}</p></div>
						<div class="stylebar" style="background-color: #f26f8e;" v-if="bgimg[15].active"><p class="stylefont">{{this.spring}}</p></div>

            <div class="stylebar" style="background-color: #b77e34;" v-if="bgimg[18].active"><p class="stylefont">{{this.spring}}</p></div>
						<div class="stylebar" style="background-color: #80ae0a;" v-if="bgimg[19].active"><p class="stylefont">{{this.spring}}</p></div>
						<div class="stylebar" style="background-color: #ff7274;" v-if="bgimg[20].active"><p class="stylefont">{{this.spring}}</p></div>
            <div class="stylebar" style="background-color: #cc1717;" v-if="bgimg[21].active"><p class="stylefont">{{this.spring}}</p></div>
            <div class="stylebar" style="background-color: #ff7900;" v-if="bgimg[22].active"><p class="stylefont">{{this.spring}}</p></div>
            <div class="stylebar" style="background-color: #ae441e;" v-if="bgimg[23].active"><p class="stylefont">{{this.spring}}</p></div>
            <div class="menulist">
							<div class="listimg">
...
<script>
    ...
    document.body.removeEventListener('touchmove',this.bodyScroll,{passive: false});
		...
		created() { //生命周期里接收参数
          ...
          this.spring=this.$route.query.spring;
      ...
      if(this.unit==='Seasons'){
        ...
        this.$axios.post(this.url, qs.stringify({
          ...
          this.partBoss1.bossbg1=this.pic+this.partBoss1.bossbg1;
          this.partBoss2.bossbg2=this.pic+this.partBoss2.bossbg2;
