    ...
    <transition name="fades">
		...
		<div class='popContainer' v-show="popp">
			...
			<div class="withcolor">
				...
				<img class="animapng7" src="http://103.218.241.33/mtgameweb/assets/img/excercise5.gif">
...
<style scoped lang="less">
	* {
    ...
    .phonics5 {
    	width: 100%;
    	height: 100%;
      background-image: url("http://107.150.121.34/monkeytownHK/image/img/phonicsbg1.png");
