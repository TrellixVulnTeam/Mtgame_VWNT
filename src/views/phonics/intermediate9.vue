  ...
  <div class="intermediate9">
    ...
    <div class='popContainer' v-show="popp">
      ...
      <div class="withcolor oringe">
        ...
        <img class="animapng7" src="http://103.218.241.33/mtgameweb/assets/img/intermediate9.gif">
...
<style scoped lang="less">
  ...
  .delete {
    ...
    border-radius: 15px;
    margin-left: -20px;
    background-image: url(http://107.150.121.34/monkeytownHK/image/img/interdelete2.png);
    color: #ffd940;
    line-height: 100%;
    font-size: 1.2rem;
  ...
  .enter {
    background: none;
    background-image: url(http://107.150.121.34/monkeytownHK/image/img/interenter2.png);
