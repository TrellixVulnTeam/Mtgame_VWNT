<template>
  <div class="intermediate3">
    <span id="gameplay">
      <audio autoplay="autoplay" loop="loop" ref="MusicPlay" v-if="show" id="partmusic">
        <source src="../../assets/video/gamemusic.mp3"></audio>
    </span>
    <img src="../../assets/image/interbg.png" style="width: 100%; z-index: -1;  height: 100%;display:block;position: absolute;">
          ...
          <div v-show="!onef" style="width: 100%; height: 90%;text-align: center;display:block;position: fixed;">
            ...
            <div class="rightbox" >
              ...
              <div class="buttons" id="imgBox">
                <button v-for="(li,index) in list1" :key="li.id" class="item listitems imgsty" v-bind:class="{changeopcily:li.fail,changetranform:li.successful,marginl:index==0}"      >
