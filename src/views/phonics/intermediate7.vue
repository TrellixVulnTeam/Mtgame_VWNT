<template>
  <div class="intermediate7">
    <img src="../../assets/image/interbg8.png" style="width: 100%; height: 100%;top:0;display:block;position: absolute;">
        ...
        <transition name="fade1">
          <div v-if="!onef" v-bind:class="{part8to2:!reload}" style="width: 100%; height: 100%;display:block;position: absolute;">
            ...
            <div class="dndList" v-if="!reload">
              ...
              <div class="allansw">
                <img src="../../assets/image/StarYellow.png" class="start" v-show="!ended1"  >
                ...
                <button class="fast"  v-bind:class="{answer: issuccess1,listimg:fangda1}">
                  <img style="position: absolute;height: auto;width:100%;display: block;bottom: 0;" src="../../assets/image/eggbox.png">
                  <span class="sort"  >{{this.sort1}}</span>
                </button>
              </div>
              <div class="allansw">
                ...
                <button class="fast2" v-bind:class="{answer: issuccess2,listimg:fangda2}">
                  <img style="position: absolute;height: auto;width:100%;display: block;bottom: 0;" src="../../assets/image/eggbox.png">
                  <span class="sort">{{this.sort2}}</span>
                </button>
              </div>
              <div class="allansw">
                ...
                <button class="fast3" v-bind:class="{answer: issuccess3,listimg:fangda3}">
                  <img style="position: absolute;height: auto;width:100%;display: block;bottom: 0;" src="../../assets/image/eggbox.png">
    ...
    <div class='popContainer' v-show="popp">
      ...
      <div class="withcolor oringe">
        ...
        <img class="animapng7" src="http://103.218.241.33/mtgameweb/assets/img/intermediate7.gif">
          ...
          if(this.over==false){
            ...
            if (this.items1.length == 0) {
                    ...
                    if (this.countpage <= this.listH.length) {
                      setTimeout(() => {
                        ...
                        for(var a=0;a<this.items1.length;a++){
                          ...
                          this.items1[a].audio=this.pic+this.items1[a].audio;
                        }
                        this.sort1=this.items1[0].sort;
                        this.sort2=this.items1[1].sort;
                        this.sort3=this.items1[2].sort;
              ...
              if (this.items4.length == 1) {
                ...
                //   setTimeout(() => {
                //     this.soundsWrong=false;
                //     if (this.countpage <= this.listH.length - 3) {
                //       setTimeout(() => {
                //         this.onef = true;
                ...
                //   }, 2000);
                // } else
                  if ($.trim(evt.removed.element.value) == $.trim(this.sort2)) {
              ...
              if (this.items5.length == 1) {
                if ($.trim(evt.removed.element.value) == $.trim(this.sort3)) {
