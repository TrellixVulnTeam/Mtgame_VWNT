<template>
  <div class="phonics8">
    ...
    <!--<img src="../../assets/image/phonicsbg3.png" style="width: 100%; z-index: -2;background-color: #204900; height: 100%;display:block;position: absolute;">-->
      ...
      <div class="contain" v-show="!resume">
        ...
        <transition name="fade1">
          <div v-if="onef" style="width: 100%; height: 90%;display:block;position: absolute;">
            <!--<img src="../../assets/image/zhizhuw.png" style="width: 100%;display:block;z-index: -1; position: absolute;">-->
            <!--<img src="../../assets/image/phonicsbg3.png" style="width: 100%; z-index: -2;background-color: #204900; height: 100%;display:block;position: absolute;">-->
            ...
            <div class="jtk-demo">
              <div class="jtk-demo-canvas canvas-wide drag-drop-demo jtk-surface jtk-surface-nopan" id="canvas">
                <div class="leftbox" v-bind:class="{leftbox1:changwidth}">
                  <div class="window" v-for="li in list1" :key="li.name" :id="li.id" v-bind:class="{window1:changwidth}"
                    @click="makesound(li)">
                    <img :src="pic+li.bg" class="imgsty" v-bind:class="{imgsty1:changwidth}" @load="loadimg">
                    <audio autoplay="autoplay" v-if="li.showbg">
                      <source :src="pic+li.audio" ></audio>
                  </div>
                </div>
    ...
    <div class='popContainer' v-show="popp">
      ...
      <div class="withcolor">
        ...
        <img class="animapng7" src="http://103.218.241.33/mtgameweb/assets/img/excercise8.gif">
