<template>
  <div class="intermediate10">
    <span id="gameplay">
      <audio autoplay="autoplay" loop="loop" ref="MusicPlay" v-if="show" id="partmusic">
        <source src="../../assets/video/gamemusic.mp3"></audio>
    </span>
    <img src="../../assets/image/interbg2.png" style="width: 100%; z-index: -1; height: 100%;display:block;position: absolute;">
    ...
    <div class='popContainer' v-show="popp">
      ...
      <div class="withcolor oringe">
        ...
        <img class="animapng7" src="http://103.218.241.33/mtgameweb/assets/img/intermediate10.gif">
