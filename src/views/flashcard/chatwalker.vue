    ...
    data() {
      return {
        ...
        mp3:{
          ...
          //January
          bowl:require('../../assets/Flashcard Audio/december/Animals.mp3'),
          cup:require('../../assets/Flashcard Audio/december/bells.mp3'),
          fish1:require('../../assets/Flashcard Audio/december/Christmas tree.mp3'),
          chopsticks:require('../../assets/Flashcard Audio/december/Coat.mp3'),
          eat:require('../../assets/Flashcard Audio/december/cold.mp3'),
          rice:require('../../assets/Flashcard Audio/december/elf.mp3'),
          chickens:require('../../assets/Flashcard Audio/december/fall.mp3'),
          drink:require('../../assets/Flashcard Audio/december/fireplace.mp3'),
          milk:require('../../assets/Flashcard Audio/december/Hang.mp3'),
          spoon:require('../../assets/Flashcard Audio/december/List.mp3'),
          tea:require('../../assets/Flashcard Audio/december/ornament.mp3'),
          vegetables:require('../../assets/Flashcard Audio/december/presents.mp3'),
          napkin:require('../../assets/Flashcard Audio/december/Pull.mp3'),
          pizza:require('../../assets/Flashcard Audio/december/reindeer.mp3'),
          fork:require('../../assets/Flashcard Audio/december/Santa claus.mp3'),
          knife:require('../../assets/Flashcard Audio/december/scarf.mp3'),
          iceCream:require('../../assets/Flashcard Audio/december/Send.mp3'),
          waiter:require('../../assets/Flashcard Audio/december/Sled.mp3'),
          menu:require('../../assets/Flashcard Audio/december/sleigh.mp3'),
          plate:require('../../assets/Flashcard Audio/december/snow.mp3'),
          order:require('../../assets/Flashcard Audio/december/snowman.mp3'),
          juice:require('../../assets/Flashcard Audio/december/stocking.mp3'),
          noodles:require('../../assets/Flashcard Audio/december/warm.mp3'),
